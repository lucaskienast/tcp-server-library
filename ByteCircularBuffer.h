//
// Created by Max Kienast on 17.11.23.
//

#ifndef TCP_IP_SERVER_BYTECIRCULARBUFFER_H
#define TCP_IP_SERVER_BYTECIRCULARBUFFER_H
...
#endif //TCP_IP_SERVER_BYTECIRCULARBUFFER_H
